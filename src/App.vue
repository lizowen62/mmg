<template>
  <v-app>
    ...
    <div class="mt-9 mr-12" style="position: absolute; right: 0; z-index: 2;">
      <v-row>
        <v-col>
          <v-btn text to="/" variant="outlined" class="mx-2">
            Accueil
          </v-btn>
          <v-btn text to="/news" variant="outlined" class="mx-2">
            Actualités
          </v-btn>
          <v-btn text to="/shop" variant="outlined" class="mx-2">
            Boutique
          </v-btn>
          <v-btn text to="/result" variant="outlined" class="mx-2">
            Résultat de tombola
          </v-btn>
        </v-col>
      </v-row>
    ...
    >
      ...
      >
        ...
        >
        <template #default>
          <div class="d-flex align-center justify-center fill-height text-white" style="flex-direction: column; gap: 1em;">
            <h1 style="font-size: 5vw;" class="font-weight-bold text-white">{{ slide.title }}</h1>
            <v-btn text :to="'/post/' + slide.slug.current" variant="outlined" class="mx-2">
              En savoir plus
            </v-btn>
          </div>
        </template>
